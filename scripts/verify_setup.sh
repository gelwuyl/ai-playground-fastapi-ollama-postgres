...
# 8. Model gemma4:12b-mlx available.
curl -s http://localhost:11434/api/tags | grep -q '"name":"gemma4:12b-mlx' \
    || fail "Model 'gemma4:12b-mlx' not pulled. Pull it: ollama pull gemma4:12b-mlx"
ok "Model gemma4:12b-mlx available"
